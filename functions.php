...
include EXP_PATH . "/includes/front/function.php";
include EXP_PATH . "/includes/front/post-types.php";
include EXP_PATH . "/includes/front/taxonamies.php";
include EXP_PATH . "/includes/front/menus.php";